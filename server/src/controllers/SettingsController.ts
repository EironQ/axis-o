...
const DEFAULT_SETTINGS: Record<string, { value: string; group: string; description: string }> = {
  ...
  airwallex_client_id: { value: '', group: 'payment', description: 'Airwallex Client ID' },
  airwallex_api_key: { value: '', group: 'payment', description: 'Airwallex API Key' },
  airwallex_webhook_signing_secret: { value: '', group: 'payment', description: 'Airwallex Webhook签名密钥' },
  airwallex_environment: { value: 'sandbox', group: 'payment', description: 'Airwallex环境' },
  lianlianpay_merchant_id: { value: '', group: 'payment', description: '连连支付商户ID' },
  lianlianpay_private_key: { value: '', group: 'payment', description: '连连支付私钥' },
  lianlianpay_public_key: { value: '', group: 'payment', description: '连连支付公钥' },
  lianlianpay_mode: { value: 'sandbox', group: 'payment', description: '连连支付模式' },
