...
CREATE INDEX `idx_discount_code` ON `discount_codes` (`code`);--> statement-breakpoint
CREATE INDEX `idx_orderitems_order` ON `order_items` (`order_id`);--> statement-breakpoint
...
CREATE INDEX `idx_pwdreset_token` ON `password_resets` (`token`);--> statement-breakpoint
...
CREATE INDEX `idx_variants_sku` ON `product_variants` (`sku`);--> statement-breakpoint
CREATE INDEX `idx_products_slug` ON `products` (`slug`);--> statement-breakpoint
CREATE INDEX `idx_products_series` ON `products` (`series`);--> statement-breakpoint
CREATE INDEX `idx_products_bestseller` ON `products` (`is_bestseller`);--> statement-breakpoint
